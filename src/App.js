      ...
      <section className="todoapp">
              ...
              todoList.map(t => {
                return (
                  <li key={t.id} className={t.completed ? "completed" : " "}>
                    <div className="view">
                      <input id={t.id} className="toggle" type="checkbox" onChange={() => getCompleted(t)} />
        ...
        <footer className="footer">
          ...
          <ul className="filters">
            <li>
              <a href="#/" className="selected" onClick={() => setTodoList(todos)}>All</a>
            </li>
            <li>
              <a href="#/" onClick={() => setTodoList(todos.filter(t => t.completed === false))}>Active</a>
            </li>
            <li>
              <a href="#/" onClick={() => setTodoList(todos.filter(t => t.completed === true))}>Completed</a>
            </li>
          </ul>
